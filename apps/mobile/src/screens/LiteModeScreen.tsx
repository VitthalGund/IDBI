  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.balanceContainer}>
        ...
        <TouchableOpacity style={styles.actionBtn} onPress={handleCheckBalance} disabled={loading}>
      ...
      <View style={styles.transferContainer}>
        ...
        />
        <TouchableOpacity style={styles.actionBtn} onPress={handleTransfer} disabled={loading}>
          <Text style={styles.btnText}>SEND MONEY</Text>
        </TouchableOpacity>
        {transferStatus ? <Text style={styles.statusText}>{transferStatus}</Text> : null}
      </View>
